...
namespace turkerHR
{
    public partial class frmEgitimBilgileri : Form
    {
        ...
        void yenile()
        {
            ...
            string sorgu = @"SELECT * FROM tblEgitimBilgileri WHERE idinsanlar=" + turkerHRInsanID.ToString() + @";";
        ...
        {
            frmEgitimBilgileriEkle frmEgitimBilgileriEkle = new frmEgitimBilgileriEkle();
            frmEgitimBilgileriEkle.turkerHRInsanID = turkerHRInsanID;
            frmEgitimBilgileriEkle.turkerHRIsim = turkerHRIsim;
            frmEgitimBilgileriEkle.turkerHRSoyad = turkerHRSoyad;
            frmEgitimBilgileriEkle.turkerHREgitimBilgiID = "-1";
            frmEgitimBilgileriEkle.ShowDialog();
            frmEgitimBilgileriEkle.Dispose();
            yenile();
        ...
        private void dataGridView1_RowHeaderMouseClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            ...
            frmEgitimBilgileriEkle.turkerHRIsim = turkerHRIsim;
            frmEgitimBilgileriEkle.turkerHRSoyad = turkerHRSoyad;
            frmEgitimBilgileriEkle.turkerHREgitimBilgiID = dataGridView1.SelectedRows[0].Cells[0].Value.ToString();
            frmEgitimBilgileriEkle.ShowDialog();
            frmEgitimBilgileriEkle.Dispose();
            yenile();
