...
namespace turkerHR
{
    public partial class frmIsTecrubeleriEkle : Form
    {
        ...
        private string _turkerHRIsTecrubeID; //forma parametre alisverisi icin
        public string turkerHRIsTecrubeID
        {
            get { return _turkerHRIsTecrubeID; }
            set { _turkerHRIsTecrubeID = value; }
        } //http://www.vcskicks.com/data-between-forms.php

        OleDbConnection con;
        OleDbCommand objKomut;

        public frmIsTecrubeleriEkle()
        {
            InitializeComponent();
        }

        private void frmIsTecrubeleriEkle_Load(object sender, EventArgs e)
        {
            if (turkerHRIsTecrubeID != "-1")
            {
                tusKilidi();
            }
            label1.Text = "Kullanıcı ID ve İsim Soyad: " + _turkerHRInsanID + " " + _turkerHRIsim + " " + _turkerHRSoyad;
            label2.Text = "Referans ID: " + turkerHRIsTecrubeID;
            ...
            string sorgu1 = @"SELECT * FROM tblIsTecrubeleri WHERE id=" + turkerHRIsTecrubeID + @";";
            ...
            while (sonuc.Read())
            {
                textBox1.Text = sonuc["kurumveyakisi"].ToString();
                textBox2.Text = sonuc["istanimi"].ToString();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
             ...
             */
                ...
                if (turkerHRIsTecrubeID != "-1")
                {
                    ...
                    con.Open();
                    string sorgu1 = @"UPDATE tblIsTecrubeleri SET";
                    //sorgu1 += " id=" + turkerHRIsTecrubeID + ",";
                    sorgu1 += " idinsanlar=" + turkerHRInsanID + ",";
                    sorgu1 += " kurumveyakisi='" + textBox1.Text + "',";
                    sorgu1 += " istanimi='" + textBox2.Text + "',";
                    sorgu1 += " baslangictarihi='" + textBox3.Text + "',";
                    sorgu1 += " bitistarihi='" + textBox4.Text + "'";
                    sorgu1 += " WHERE id=" + turkerHRIsTecrubeID.ToString() + @";";
                ...
                else // yani yeni kayıt
                {
                    ...
                    string sorgu1 = @"INSERT INTO tblIsTecrubeleri ";
                    sorgu1 += "(";
                    sorgu1 += "idinsanlar, kurumveyakisi, istanimi, baslangictarihi, bitistarihi";
                    sorgu1 += ") VALUES (";
                    // sorgu1 += "VALUES (";
                    // sorgu1 += "NULL, ";
