...
namespace turkerHR
{
    public partial class frmKurslarSertifikalar : Form
    {
        ...
        public frmKurslarSertifikalar()
        {
            InitializeComponent();
        }

        private void frmKurslarSertifikalar_Load(object sender, EventArgs e)
        {
            yenile();
        ...
        void yenile()
        {
            ...
            string sorgu = @"SELECT * FROM tblKurslarSertifikalar WHERE idinsanlar=" + turkerHRInsanID.ToString() + @";";
        ...
        {
            frmKurslarSertifikalarEkle frmKursSertifikaEkle = new frmKurslarSertifikalarEkle();
            frmKursSertifikaEkle.turkerHRInsanID = turkerHRInsanID;
            frmKursSertifikaEkle.turkerHRIsim = turkerHRIsim;
            frmKursSertifikaEkle.turkerHRSoyad = turkerHRSoyad;
            frmKursSertifikaEkle.turkerHRKursSertifikaID = "-1";
            frmKursSertifikaEkle.ShowDialog();
            frmKursSertifikaEkle.Dispose();
            yenile();
        ...
        private void dataGridView1_RowHeaderMouseClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            ...
            frmKursSertifikaEkle.turkerHRIsim = turkerHRIsim;
            frmKursSertifikaEkle.turkerHRSoyad = turkerHRSoyad;
            frmKursSertifikaEkle.turkerHRKursSertifikaID = dataGridView1.SelectedRows[0].Cells[0].Value.ToString();
            frmKursSertifikaEkle.ShowDialog();
            frmKursSertifikaEkle.Dispose();
            yenile();
