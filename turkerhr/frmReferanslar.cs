...
namespace turkerHR
{
    public partial class frmReferanslar : Form
    {
        ...
        public frmReferanslar()
        {
            InitializeComponent();
        }

        private void frmReferanslar_Load(object sender, EventArgs e)
        {
        ...
        void yenile()
        {
            ...
            string sorgu = @"SELECT * FROM tblReferanslar WHERE idinsanlar=" + turkerHRInsanID.ToString() + @";";
        ...
        {
            frmReferanslarEkle frmReferansEkle = new frmReferanslarEkle();
            frmReferansEkle.turkerHRInsanID = turkerHRInsanID;
            frmReferansEkle.turkerHRIsim = turkerHRIsim;
            frmReferansEkle.turkerHRSoyad = turkerHRSoyad;
            frmReferansEkle.turkerHRReferansID = "-1";          
            frmReferansEkle.ShowDialog();
            frmReferansEkle.Dispose();
            yenile();
        ...
        private void dataGridView1_RowHeaderMouseClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            ...
            frmReferansEkle.turkerHRIsim = turkerHRIsim;
            frmReferansEkle.turkerHRSoyad = turkerHRSoyad;
            frmReferansEkle.turkerHRReferansID = dataGridView1.SelectedRows[0].Cells[0].Value.ToString();
            frmReferansEkle.ShowDialog();
            frmReferansEkle.Dispose();
            yenile();
