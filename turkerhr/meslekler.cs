...
namespace turkerHR
{
	...
	public partial class meslekler : Form
	{
       ...
       OleDbCommand objKomut;
		...
		void MesleklerLoad(object sender, EventArgs e)
		{
           ...
           // this.seviyeTableAdapter.Fill(this.turkerHRveritabaniDataSet2.seviye);
            ...
            string sorgu1 = "SELECT count(*) FROM idinsanlar_idpozisyonlar WHERE idinsanlar=" + turkerHRInsanID.ToString() + ";";
            ...
            con.Open();
            string sql = "SELECT idpozisyonlar FROM idinsanlar_idpozisyonlar WHERE idinsanlar=" + turkerHRInsanID.ToString() + ";";
        ...
        {
            con.Open();
            string sorgu3 = "SELECT count(*) FROM pozisyonlar;";
            objKomut.CommandText = sorgu3;
            int mesleksayisi = Convert.ToInt32(objKomut.ExecuteScalar());
                    ...
                    if (((CheckBox)kontrol).Name.ToString().Equals("kutu" + sayi.ToString())) // benim dinamik nesnelerimin isimleri kutu1,kutu2,... şeklinde.
                    {
                        if (((CheckBox)kontrol).Checked == true) // sadece seçili olan kutular.
                        {
                            ...
                            try
                            {
                                ...
                                string sorgu6 = "SELECT DISTINCT idinsanlar,idpozisyonlar FROM idinsanlar_idpozisyonlar WHERE ";
                                sorgu6 += "idinsanlar=" + turkerHRInsanID.ToString() + " AND ";
                                sorgu6 += "idpozisyonlar=" + (sayi + 1).ToString() +";";
                                ...
                                {
                                    string sorgu4 = "INSERT INTO idinsanlar_idpozisyonlar(idinsanlar, idpozisyonlar) VALUES (" + turkerHRInsanID.ToString() + ", " + (sayi + 1).ToString() + ");";
                        ...
                        else if (((CheckBox)kontrol).Checked == false) // sadece seçili olan kutular.
                        {
                            ...
                            string sorgu4 = "DELETE FROM idinsanlar_idpozisyonlar WHERE idinsanlar="+turkerHRInsanID.ToString()+ " AND idpozisyonlar=" + (sayi+1).ToString() + ";";
                            objKomut.CommandText = sorgu4;
                            int sonuc5 = Convert.ToInt32(objKomut.ExecuteScalar());
                        }
                    }
